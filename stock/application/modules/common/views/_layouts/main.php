            ...
            <ul class="nav pull-right">
                        ...
                        <li>
                            <ul class="dropdown-menu-list scroller" style="height:250px">
                                <li>
                                    <a href="inbox.html?a=view">
                                        <span class="photo"><img
                                                src="<?php echo site_url('./assets/img/avatar2.jpg') ?>"
                                                alt="" /></span>
                                        <span class="subject">
                                ...
                                <li>
                                    <a href="inbox.html?a=view">
                                        <span class="photo"><img
                                                src="<?php echo site_url('./assets/img/avatar3.jpg') ?>"
                                                alt="" /></span>
                                        <span class="subject">
                ...
                <li class="dropdown user">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="#"><i class="icon-tasks"></i> My Tasks <span
                                    class="badge badge-success">8</span></a></li>
                        <li class="divider"></li>
                        <li><a href="javascript:;" id="trigger_fullscreen"><i class="icon-move"></i> Full Screen</a>
                        </li>
                        <li><a href="extra_lock.html"><i class="icon-lock"></i> Lock Screen</a></li>
                        <li><a href="<?php echo site_url('public/user/logout') ?>"><i class="icon-key"></i> Log Out</a></li>
                    </ul>
                </li>
